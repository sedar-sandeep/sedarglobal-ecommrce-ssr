...
export const loadCaptchaEnginge2 = (numberOfCharacters, backgroundColor = 'white', fontColor = 'black', charMap = '') => {
    ...
    document.getElementById("reload_href2").onclick = function () {
        loadCaptchaEnginge2(captcha_number, backgroundColor, fontColor, charMap);
    }
...
export const validateCaptcha2 = (userValue, reload = true) => {
    if (userValue != captcha_value) {
        if (reload == true) {
            loadCaptchaEnginge2(captcha_number, backgroundColor_value, fontColor_value, charMap_value);
        }
...
export class LoadCanvasTemplate2 extends Component {

    render() {
        let reload_text = "";
        let reload_color = "";
        LoadCanvasTemplate_HTML = "<div><canvas id=\"canv2\" style=\"background-color: blue;\"></canvas><div><a id=\"reload_href2\"  style=\"cursor: pointer; color: blue\">Reload Captcha</a></div></div>";
        ...
        LoadCanvasTemplate_HTML = "<div><canvas id=\"canv2\"></canvas><div><a id=\"reload_href2\"  style=\"cursor: pointer; color: " + reload_color + "\">" + reload_text + "</a></div></div>";
