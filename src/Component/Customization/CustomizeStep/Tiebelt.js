...
const Tiebelt = (props) => {
  ...
  useEffect(() => {
    ...
    props.SUB_CHILD.map((data) => {
      ...
      if (edit_step.info_result && edit_step.info_result.TIEBELT && edit_step.info_result.TIEBELT.SOI_SPS_CODE == data.SPS_CODE) {
