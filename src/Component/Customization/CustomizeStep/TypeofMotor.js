...
const TypeofMotor = (props) => {
    ...
    useEffect(() => {
        ...
        props.SUB_CHILD.map((data) => {
            if (edit_step.info_result && edit_step.info_result.TYPE_OF_MOTOR && edit_step.info_result.TYPE_OF_MOTOR.SOI_SPS_CODE == data.SPS_CODE) {
...
TypeofMotor.propTypes = {};

TypeofMotor.defaultProps = {};
