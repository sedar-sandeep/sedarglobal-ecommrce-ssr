...
const BottomBar = (props) => {
  ...
  useEffect(() => {
    ...
    props.SUB_CHILD.map((data) => {
      if (edit_step.info_result && edit_step.info_result.BOTTOM_BAR && edit_step.info_result.BOTTOM_BAR.SOI_SPS_CODE == data.SPS_CODE) {
