...
const DeleteList = (props) => {
    ...
    return (
        <>
            {props.delete_list && props.delete_list.length > 0 ?
                <Row className="delete_list m-0">
                    <h3 className="my-4 pb-3"> {t("delete_list")} </h3>
                    {props.delete_list && props.delete_list.map((data, index) => {
                        n++;
                        return (
